...
### SendGrid (1 secret)
```bash
SENDGRID_API_KEY=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
```
...
### Anthropic (Claude)
```bash
ANTHROPIC_API_KEY=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
```
...
### OpenRouter
```bash
OPENROUTER_API_KEY=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
```
...
TWILIO_AUTH_TOKEN=c41bbe10082bd4d290ed1d41b624e05a
...
GOOGLE_CLIENT_SECRET=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
