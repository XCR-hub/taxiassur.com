-- ══════════════════════════════════════════════════════════════════
--  TEMPLATES EMAILS PRODUCTION - Campagne Backlinks
-- ══════════════════════════════════════════════════════════════════

-- Supprimer anciens templates si existent
DELETE FROM email_templates WHERE category = 'backlink_outreach';

-- TEMPLATE 1: Premier Contact (Soft Approach)
...
-- TEMPLATE 2: Relance (7 jours après)
INSERT INTO email_templates (
  name, subject, body, category, variables, metadata
) VALUES (
  'backlink_relance_1',
...
-- TEMPLATE 3: Dernière Relance (14 jours après relance 1)
INSERT INTO email_templates (
  name, subject, body, category, variables, metadata
) VALUES (
...
-- TEMPLATE 4: Email de remerciement (après acceptation)
INSERT INTO email_templates (
  name, subject, body, category, variables, metadata
) VALUES (
