-- ============================================================================
-- SOLUTION COMPLÈTE - EXÉCUTER DANS CET ORDRE
-- ============================================================================
...
-- Ajouter colonnes à social_posts
...
-- Ajouter colonnes à taxi_prospects
...
-- ============================================================================
-- PARTIE 2 : CRÉER FONCTION publish_to_social_media
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION publish_to_social_media TO authenticated, service_role;

-- ============================================================================
-- PARTIE 3 : CRÉER FONCTION generate_blog_post_ai
-- ============================================================================
...
GRANT EXECUTE ON FUNCTION generate_blog_post_ai TO authenticated, service_role;

-- ============================================================================
-- PARTIE 4 : CRÉER FONCTION scrape_taxi_companies (SANS AMBIGUÏTÉ)
-- ============================================================================
...
SELECT 'TOUTES LES CORRECTIONS APPLIQUÉES - Testez maintenant:' as message
UNION ALL
SELECT 'SELECT * FROM scrape_taxi_companies(''Paris'');'
UNION ALL
SELECT 'SELECT * FROM publish_to_social_media(''linkedin'', ''Test post'');'
UNION ALL
SELECT 'SELECT * FROM generate_blog_post_ai(''Titre test'');';
