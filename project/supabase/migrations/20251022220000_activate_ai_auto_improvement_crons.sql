...
BEGIN
  ...
  RAISE NOTICE '   - Deploiement si +15%% conversion';
  RAISE NOTICE '   - Rollback auto si echec';
  RAISE NOTICE ' ';
  RAISE NOTICE 'CONFIGURATION REQUISE:';
  RAISE NOTICE '   1. GITHUB_TOKEN dans Supabase Vault';
  RAISE NOTICE '   2. GITHUB_REPO (ex: XCR-hub/taxiassur.com)';
  RAISE NOTICE '   3. FTP_HOST, FTP_USER, FTP_PASSWORD';
  RAISE NOTICE '   4. OPENAI_API_KEY (deja configuree)';
  RAISE NOTICE ' ';
