/*
  # Force Drop and Recreate get_current_seo_metrics()
  ...
  2. Solution
    - DROP FUNCTION avec CASCADE pour forcer suppression
    - Recréer avec nouvelle signature
*/

-- Force drop avec CASCADE (supprime dépendances)
DROP FUNCTION IF EXISTS get_current_seo_metrics() CASCADE;

-- Recréer fonction avec logique simplifiée
