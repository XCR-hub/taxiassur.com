/*
  # Fix Blog Slugs + Anti-Doublon System (Syntax Corrigée)
...
DO $$
BEGIN
  -- Supprimer contrainte si existe déjà
  IF EXISTS (
...
BEGIN
  ...
  RAISE NOTICE '🔗 Contrainte UNIQUE: ACTIVE';
  RAISE NOTICE '';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
  RAISE NOTICE '🎯 URLs articles maintenant propres et fonctionnelles';
  RAISE NOTICE '🚫 Plus de doublons possibles';
  RAISE NOTICE '⏱️ 1 seule génération à la fois (verrou 5min)';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
END $$;
