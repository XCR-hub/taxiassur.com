        ...
        <ul className="space-y-3">
          {internalLinks.map((link, index) => (
            <li key={index}>
              <Link
                to={link.url}
                className="flex items-start gap-2 text-sm text-gray-300 hover:text-yellow-500 transition-colors group"
              >
                <ArrowRight className="w-4 h-4 mt-0.5 flex-shrink-0 text-yellow-500 group-hover:translate-x-1 transition-transform" />
