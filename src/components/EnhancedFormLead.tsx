        ...
        <div className="flex justify-between mt-6">
          ...
          {currentStep < 3 ? (
            <button
              ...
              className="ml-auto px-4 py-2 bg-amber-500 hover:bg-amber-600 disabled:bg-gray-700 disabled:text-gray-300 text-black font-medium rounded-lg transition-colors text-sm"
            >
              Suivant
            </button>
          ) : (
