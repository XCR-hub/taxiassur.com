      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm">Réseaux disponibles</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm">Réseaux actifs</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm">Engagement total</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm">Clics totaux</p>
          </div>
        </div>
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            {network.account_name && (
                              <p className="text-xs text-slate-400">@{network.account_name}</p>
                            )}
                          </div>
                        </div>
                        <button
                          ...
                          className={`px-3 py-1 rounded-full text-xs font-medium transition-all ${
                            network.is_connected
                              ...
                              : 'bg-gray-700 text-slate-300 border border-slate-600'
                          }`}
                        >
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span className="text-slate-400">Auto-publication:</span>
                          <span className={network.auto_publish ? 'text-green-400' : 'text-slate-400'}>
                            {network.auto_publish ? 'Activée' : 'Désactivée'}
                          </span>
                        </div>
                        {network.last_post_at && (
                          <div className="flex justify-between">
                            <span className="text-slate-400">Dernier post:</span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400"
                  >
                  ...
                  return (
                    <div key={post.id} className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                      ...
                      <div className="grid grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="text-center">
                          <p className="text-slate-400 text-xs">Partages</p>
          ...
          <div className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {whatsappGroups.map((group) => (
                <div key={group.id} className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-400">Auto-envoi:</span>
                      <span className={group.auto_send ? 'text-green-400' : 'text-slate-400'}>
            ...
            {whatsappGroups.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-400">Aucun groupe WhatsApp configuré</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-4">
                    📄 Voir le fichier: <code className="bg-slate-900 px-2 py-1 rounded text-yellow-400">AUTOMATION-SOCIAL-MEDIA-GUIDE.md</code>
                  </p>
                </div>
              </div>
            </div>
