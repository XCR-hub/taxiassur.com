...
export const nativeAdminCreateMoneticoPayment=(body:{leadId:string;amount:number;description:string;requestId:string})=>call('/v1/admin/payments',{method:'POST',body:JSON.stringify(body),signal:AbortSignal.timeout(45_000)});
