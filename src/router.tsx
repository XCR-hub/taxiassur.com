...
const EmailInboxOutlook = lazy(() => import('./backoffice/EmailInboxOutlook'));
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <SuspenseWrapper><NewsletterSubscribe /></SuspenseWrapper>,
        errorElement: <RouteErrorFallback />
      },
      {
        path: '/newsletter/unsubscribe',
        element: <SuspenseWrapper><NewsletterUnsubscribe /></SuspenseWrapper>,
        errorElement: <RouteErrorFallback />
      },
      {
      ...
      },
      {
        ...
        element: <AuthGuard><SuspenseWrapper><QuoteManager /></SuspenseWrapper></AuthGuard>
      },
      {
