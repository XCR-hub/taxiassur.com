...
const AssuranceTaxiAixEnProvence: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Assurance Taxi Aix-en-Provence : Tarifs 2024 | TaxiAssur</title>
        ...
        <meta property="og:title" content="Assurance Taxi Aix-en-Provence : Tarifs 2024 | TaxiAssur" />
        <meta property="og:description" content="Assurance Taxi Aix-en-Provence dès 1580€/an (-35%). RC Pro incluse." />
        <meta property="og:url" content="https://taxiassur.com/assurance-taxi-aix-en-provence" />
        ...
        <meta name="twitter:title" content="Assurance Taxi Aix-en-Provence : Tarifs 2024 | TaxiAssur" />
        <meta name="twitter:description" content="Assurance Taxi Aix-en-Provence dès 1580€/an (-35%). RC Pro incluse." />
      ...
      <main>
        <section className="bg-gradient-to-r from-yellow-900 to-orange-900 text-white py-20 text-center">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-black mb-6">Assurance Taxi Aix-en-Provence<br/><span className="text-yellow-400">1580€/an</span></h1>
            <a href="#devis" className="bg-yellow-400 text-yellow-900 font-bold px-8 py-4 rounded-xl inline-block">Devis →</a>
          </div>
        </section>
        <section className="py-16 bg-white text-center">
          <div className="container mx-auto px-4">
            <div className="text-5xl font-black text-yellow-600 mb-4">1580€/an</div>
          </div>
        </section>
        <section id="devis" className="py-16 bg-yellow-900 text-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-8">Devis Aix-en-Provence</h2>
            <EnhancedLeadForm />
          </div>
        </section>
      </main>
