...
const AssuranceTaxiBrest: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Assurance Taxi Brest : Tarifs 2024 | TaxiAssur" />
        <meta property="og:description" content="Assurance Taxi Brest dès 1470€/an (-35%). RC Pro incluse." />
        <meta property="og:url" content="https://taxiassur.com/assurance-taxi-brest" />
        ...
        <meta name="twitter:title" content="Assurance Taxi Brest : Tarifs 2024 | TaxiAssur" />
        <meta name="twitter:description" content="Assurance Taxi Brest dès 1470€/an (-35%). RC Pro incluse." />
      ...
      <main>
        <section className="bg-gradient-to-r from-yellow-900 to-orange-900 text-white py-20 text-center">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-black mb-6">Assurance Taxi Brest<br/><span className="text-yellow-400">1470€/an</span></h1>
            <a href="#devis" className="bg-yellow-400 text-yellow-900 font-bold px-8 py-4 rounded-xl inline-block">Devis →</a>
          </div>
        </section>
        <section className="py-16 bg-white text-center">
          <div className="container mx-auto px-4">
            <div className="text-5xl font-black text-yellow-600 mb-4">1470€/an</div>
          </div>
        </section>
        <section id="devis" className="py-16 bg-yellow-900 text-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-8">Devis Brest</h2>
            <EnhancedLeadForm />
          </div>
        </section>
      </main>
...
export default AssuranceTaxiBrest;
