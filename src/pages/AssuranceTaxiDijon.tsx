...
const AssuranceTaxiDijon: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Assurance Taxi Dijon : Tarifs 2024 | TaxiAssur</title>
        ...
        <meta property="og:title" content="Assurance Taxi Dijon : Tarifs 2024 | TaxiAssur" />
        <meta property="og:description" content="Assurance Taxi Dijon dès 1430€/an. RC Pro incluse, assistance 24/7. Devis gratuit 2 min." />
        <meta property="og:url" content="https://taxiassur.com/assurance-taxi-dijon" />
        ...
        <meta name="twitter:title" content="Assurance Taxi Dijon : Tarifs 2024 | TaxiAssur" />
        <meta name="twitter:description" content="Assurance Taxi Dijon dès 1430€/an. RC Pro incluse, assistance 24/7. Devis gratuit 2 min." />
      ...
      <main>
        <section className="bg-gradient-to-r from-orange-900 to-orange-800 text-white py-20 text-center">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-black mb-6">Assurance Taxi Dijon<br/><span className="text-yellow-400">1430€/an</span></h1>
            <a href="#devis" className="bg-yellow-400 text-orange-900 font-bold px-8 py-4 rounded-xl inline-block">Devis Gratuit →</a>
          </div>
        </section>
        <section className="py-16 bg-white text-center">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-black mb-8">Tarif Dijon</h2>
        ...
        <section id="devis" className="py-16 bg-orange-900 text-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-black text-center mb-8">Devis Dijon</h2>
            <EnhancedLeadForm />
          </div>
        </section>
      </main>
...
export default AssuranceTaxiDijon;
