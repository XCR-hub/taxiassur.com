...
const AssuranceTaxiLeMans: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Assurance Taxi Le-Mans : Tarifs 2024 | TaxiAssur</title>
        ...
        <meta property="og:title" content="Assurance Taxi Le-Mans : Tarifs 2024 | TaxiAssur" />
        <meta property="og:description" content="Assurance Taxi Le-Mans dès 1400€/an (-35%). RC Pro incluse." />
        <meta property="og:url" content="https://taxiassur.com/assurance-taxi-le-mans" />
        ...
        <meta name="twitter:title" content="Assurance Taxi Le-Mans : Tarifs 2024 | TaxiAssur" />
        <meta name="twitter:description" content="Assurance Taxi Le-Mans dès 1400€/an (-35%). RC Pro incluse." />
...
export default AssuranceTaxiLeMans;
