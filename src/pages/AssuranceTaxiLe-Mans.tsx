...
const AssuranceTaxiLe-Mans: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.taxiassur.com/assurance-taxi-le-mans" />
      </Helmet>
      <Header />
      <main>
        ...
        <section className="py-16 bg-white text-center">
          <div className="container mx-auto px-4">
            <div className="text-5xl font-black text-indigo-600 mb-4">1400€/an</div>
          </div>
        </section>
...
export default AssuranceTaxiLe-Mans;
