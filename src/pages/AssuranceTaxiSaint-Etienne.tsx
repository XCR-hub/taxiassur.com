...
const AssuranceTaxiSaint-Etienne: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.taxiassur.com/assurance-taxi-saint-etienne" />
      </Helmet>
      <Header />
      <main>
        ...
        <section className="py-16 bg-white text-center">
          <div className="container mx-auto px-4">
            ...
            <div className="text-5xl font-black text-blue-600 mb-4">1380€/an</div>
...
export default AssuranceTaxiSaint-Etienne;
