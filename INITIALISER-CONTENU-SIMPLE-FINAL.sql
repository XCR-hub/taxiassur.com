-- ============================================================================
-- INITIALISATION CONTENU - VERSION SIMPLE FINALE (SANS ON CONFLICT)
-- ============================================================================
...
DELETE FROM faq_entries WHERE question IN (
...
DELETE FROM reviews WHERE name IN (
  'Jean-Pierre M.', 'Marie L.', 'Ahmed K.', 'David R.', 'Fatima R.', 'Mohammed B.'
);

-- 2. Insérer des articles de blog
...
-- 3. Insérer des FAQ
INSERT INTO faq_entries (question, answer, category, status, created_at) VALUES
  (
    'Quel est le coût moyen d''une assurance taxi ?',
...
-- 7. Activer l'IA Maître
INSERT INTO ai_master_status (is_active, mode, last_update)
VALUES (true, 'auto', NOW())
