  ...
  switch (task_action) {
    case "send_welcome_email": {
      const content = `
        ...
        <p><a href="https://taxiassur.com/prospect/documents?lead=${lead.id}">Deposer mes documents</a></p>
      `;
    ...
    case "send_document_request": {
      const content = `
        ...
        <p><a href="https://taxiassur.com/prospect/documents?token=${lead.id}" style="background:#2563eb;color:white;padding:12px 24px;text-decoration:none;border-radius:6px;display:inline-block;margin:20px 0;">DEPOSER MES DOCUMENTS</a></p>
    ...
    case "send_urgent_reminder": {
      ...
      const content = `
        ...
        <p><a href="https://taxiassur.com/prospect/documents?token=${lead.id}">Deposer mes documents maintenant</a></p>
      `;
