// VERSION AVEC SECRETS SUPABASE (à activer une fois les identifiants obtenus)
...
// Récupération depuis les secrets Supabase (plus sécurisé)
const MONETICO_CONFIG = {
  tpe: Deno.env.get('MONETICO_TPE') || '7374133',
  societe: Deno.env.get('MONETICO_SOCIETE') || 'taxiassur',
  macKey: Deno.env.get('MONETICO_MAC_KEY') || '106FA85BF342FD4EE95C883D82865B5CC1F63890',
  version: '3.0',
  langue: 'FR',
  urlServeur: Deno.env.get('MONETICO_URL') || 'https://p.monetico-services.com/paiement.cgi',
