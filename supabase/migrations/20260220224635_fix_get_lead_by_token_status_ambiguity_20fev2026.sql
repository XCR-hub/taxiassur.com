/*
  # Fix get_lead_by_token - Ambiguïté colonne status - 20 février 2026

  ## Problème identifié

  Ambiguïté entre la colonne `status` dans le RETURNS TABLE et dans la requête SQL.

  ## Solution

  Qualifier toutes les colonnes avec le nom de la table (crm_lead_documents.status)
*/
...
'Récupère un lead par son access_token (corrigé ambiguïté status)';
