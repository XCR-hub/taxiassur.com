/*
  # Fix validate_document - Remove ON CONFLICT
  
  1. Problem
    - ON CONFLICT requires unique constraint on (lead_id, document_type)
    - This constraint doesn't exist
...
'Valide un document par lead_id + document_type - FIXED: no more ON CONFLICT error';
