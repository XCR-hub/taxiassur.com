/*
  # Fix ambiguïté dans upsert_lead
  
  Correction de l'erreur "column reference access_token is ambiguous"
  en qualifiant explicitement les noms de colonnes
*/
...
BEGIN
  -- Vérifier si un lead existe déjà avec cet email (qualification explicite)
