/*
  # Fix Email Notification - Utiliser extension http correctement
  
  ## Problème
  La fonction utilise net.http_post mais l'extension installée est 'http' (pas 'pg_net')
  
  ## Solution
  Corriger pour utiliser http_post directement (extension http v1.6)
*/
...
COMMENT ON FUNCTION sync_prospect_document_to_crm() IS 'Synchro prospect → CRM + Email immédiat au commercial assigné (utilise extension http v1.6)';
