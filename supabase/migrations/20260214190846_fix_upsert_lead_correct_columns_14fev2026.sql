/*
  # Fix upsert_lead avec les bonnes colonnes
  
  Utilise les colonnes qui existent réellement dans crm_leads :
  - current_stage_key au lieu de current_stage
  - pipeline_stage pour la compatibilité
*/
