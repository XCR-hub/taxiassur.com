/*
  # Fix erreur "ambiguous column" dans upsert_lead
  
  Erreur : column reference "access_token" is ambiguous
  Solution : Qualifier les colonnes avec le nom de la table (crm_leads.access_token)
*/
...
BEGIN
  ...
  -- Vérifier si le lead existe (qualifier les colonnes avec le nom de la table)
