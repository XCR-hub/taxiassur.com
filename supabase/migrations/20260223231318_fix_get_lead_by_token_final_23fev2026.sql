/*
  # FIX FINAL get_lead_by_token - Toutes colonnes correctes

  Correction finale avec les vraies colonnes :
  - lead_company_quotes.quote_amount (pas amount)
  - prospect_documents sans file_url
*/
