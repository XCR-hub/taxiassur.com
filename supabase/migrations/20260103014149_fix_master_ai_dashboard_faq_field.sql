/*
  # Correction fonction get_ai_master_dashboard - champ FAQ
  
  Correction du champ is_published vers published_at pour la table faq_items
*/
...
BEGIN
  ...
  -- FAQ (correction: utiliser published_at au lieu de is_published)
