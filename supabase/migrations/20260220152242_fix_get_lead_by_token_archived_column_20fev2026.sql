/*
  # Fix get_lead_by_token - Correction colonne archived

  ## Problème
  La fonction utilise archived_at qui n'existe pas
  La colonne correcte est is_archived (boolean)

  ## Solution
  Remplacer archived_at IS NULL par is_archived = false
*/
